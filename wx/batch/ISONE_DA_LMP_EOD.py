...
class ISONE_DA_LMP_Command(Command):
    """
        This is the command line interface for saving DA LMP data from ISO-NE at the end of every day.
    """
    ...
    def run(self, as_of_date='today', sys='unix'):
        ...
        MS.isone_da_lmp(start_date=start, end_date=end)

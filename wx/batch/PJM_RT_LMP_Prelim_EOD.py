...
class PJM_RT_LMP_Prelim_Command(Command):
    """
        This is the command line interface for saving RT LMP prelim data from PJM at the end of every day.
    """
    ...
    def run(self, as_of_date='today', sys='unix'):
        ...
        MS.pjm_rt_lmp_prelim(start_date=start, end_date=end)

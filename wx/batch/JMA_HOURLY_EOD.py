...
class JMA_HOURLY_Command(Command):
    """
    ...
    def run(self, as_of_date='today', sys='unix'):
        ...
        :return:
        """
        base_url_max = 'https://www.data.jma.go.jp/obd/stats/data/mdrr/tem_rct/alltable/mxtemsadext00_'
        base_url_min = 'https://www.data.jma.go.jp/obd/stats/data/mdrr/tem_rct/alltable/mntemsadext00_'
        run_dates = []
        run_dates.append(datetime.today() - timedelta(days=1))
        run_dates.append(datetime.today() - timedelta(days=0))
        for d in run_dates:
            WP.get_jma_data(d,base_url_max,base_url_min)
        pass

...
class ERCOT_RT_SPP_Command(Command):
    """
        This is the command line interface for saving RT SPP data from ERCOT at the end of every day.
    """
    ...
    def run(self, as_of_date='today', sys='unix'):
        ...
        MS.ercot_rt_spp(start_date=start, end_date=end)

...
class BOC_EXCHANGE_RATES_Command(Command):
    """
        This is the command line interface for saving DAM SPP data from ERCOT at the end of every day.
    """
    ...
    def run(self, as_of_date='today', sys='unix'):
        ...
        MS.exchange_rates(start_date=start, end_date=end)
